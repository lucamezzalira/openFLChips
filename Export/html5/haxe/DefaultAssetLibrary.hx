...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("assets/chip.png", __ASSET__assets_chip_png);
		type.set ("assets/chip.png", Reflect.field (AssetType, "image".toUpperCase ()));
		
		
		#elseif html5
		
		addExternal("assets/chip.png", "image", "assets/chip.png");
...
@:keep class __ASSET__assets_chip_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
