...
{
		HX_STACK_FRAME("haxe.io.Bytes","blit",0xd098ac78,"haxe.io.Bytes.blit","/usr/lib/haxe/std/haxe/io/Bytes.hx",68,0x9329f754)
		HX_STACK_THIS(this)
...
::haxe::io::Bytes Bytes_obj::sub( int pos,int len){
	HX_STACK_FRAME("haxe.io.Bytes","sub",0x393cae9d,"haxe.io.Bytes.sub","/usr/lib/haxe/std/haxe/io/Bytes.hx",116,0x9329f754)
	HX_STACK_THIS(this)
	HX_STACK_ARG(pos,"pos")
	HX_STACK_ARG(len,"len")
	HX_STACK_LINE(118)
...
::haxe::io::Bytes Bytes_obj::alloc( int length){
	HX_STACK_FRAME("haxe.io.Bytes","alloc",0x2199ead2,"haxe.io.Bytes.alloc","/usr/lib/haxe/std/haxe/io/Bytes.hx",267,0x9329f754)
	HX_STACK_ARG(length,"length")
	HX_STACK_LINE(277)
...
::haxe::io::Bytes Bytes_obj::ofString( ::String s){
	HX_STACK_FRAME("haxe.io.Bytes","ofString",0x6e53bb0b,"haxe.io.Bytes.ofString","/usr/lib/haxe/std/haxe/io/Bytes.hx",292,0x9329f754)
	HX_STACK_ARG(s,"s")
	HX_STACK_LINE(303)
	Array< unsigned char > a = Array_obj< unsigned char >::__new();		HX_STACK_VAR(a,"a");
	HX_STACK_LINE(304)
...
::haxe::io::Bytes Bytes_obj::ofData( Array< unsigned char > b){
	HX_STACK_FRAME("haxe.io.Bytes","ofData",0x4f3005e4,"haxe.io.Bytes.ofData","/usr/lib/haxe/std/haxe/io/Bytes.hx",351,0x9329f754)
	HX_STACK_ARG(b,"b")
	HX_STACK_LINE(351)
