...
Void ApplicationMain_obj::main( ){
{
		...
		bool run(int orientation){
			HX_STACK_FRAME("*","_Function_1_1",0x5200ed37,"*._Function_1_1","ApplicationMain.hx",24,0x0780ded5)
		...
		HX_STACK_LINE(94)
		int _g1 = ::flash::Lib_obj::REQUIRE_SHADERS;		HX_STACK_VAR(_g1,"_g1");
		HX_STACK_LINE(95)
		...
		HX_STACK_LINE(100)
		int _g7 = ::flash::Lib_obj::FULLSCREEN;		HX_STACK_VAR(_g7,"_g7");
		HX_STACK_LINE(101)
		...
		Void run(){
			HX_STACK_FRAME("*","_Function_1_2",0x5200ed38,"*._Function_1_2","ApplicationMain.hx",32,0x0780ded5)
			{
				HX_STACK_LINE(34)
		...
		HX_STACK_LINE(32)
		::flash::Lib_obj::create( Dynamic(new _Function_1_2()),(int)0,(int)0,(int)30,(int)16777215,(int((int((int((int((int((int((int((int((int((int(::flash::Lib_obj::HARDWARE) | int(_g))) | int(_g1))) | int(_g2))) | int(_g3))) | int(_g4))) | int(_g5))) | int(_g6))) | int(_g7))) | int(_g8))) | int(_g9)),HX_CSTRING("BlackJack"),null(),null());
	}
return null();
}
