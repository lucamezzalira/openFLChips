...
Void TransformActuator_obj::apply( ){
{
		...
		if (((this->endColorTransform != null()))){
			HX_STACK_LINE(38)
			::flash::geom::Transform transform;		HX_STACK_VAR(transform,"transform");
			HX_STACK_LINE(38)
			{
				HX_STACK_LINE(38)
...
Void TransformActuator_obj::initialize( ){
{
		...
		HX_STACK_THIS(this)
		HX_STACK_LINE(54)
		if (((  ((::Reflect_obj::hasField(this->properties,HX_CSTRING("colorValue")))) ? bool(::Std_obj::is(this->target,hx::ClassOf< ::flash::display::DisplayObject >())) : bool(false) ))){
			HX_STACK_LINE(56)
...
Void TransformActuator_obj::initializeColor( ){
{
		...
		HX_STACK_LINE(132)
		::flash::geom::ColorTransform begin;		HX_STACK_VAR(begin,"begin");
			...
			while(((_g < propertyNames->length))){
				...
				struct _Function_3_2{
					inline static Dynamic Block( ::motion::actuators::TransformActuator_obj *__this,::String &propertyName){
						HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","motion/actuators/TransformActuator.hx",141,0x0795ec87)
						{
							HX_STACK_LINE(141)
...
Void TransformActuator_obj::initializeSound( ){
{
		...
		struct _Function_1_1{
			inline static Dynamic Block( ::motion::actuators::TransformActuator_obj *__this){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","motion/actuators/TransformActuator.hx",151,0x0795ec87)
				{
					HX_STACK_LINE(151)
		...
		HX_STACK_LINE(157)
		::flash::media::SoundTransform start;		HX_STACK_VAR(start,"start");
		HX_STACK_LINE(157)
		{
			HX_STACK_LINE(157)
			Dynamic target = this->target;		HX_STACK_VAR(target,"target");
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsObject /*::flash::geom::ColorTransform*/ ,(int)offsetof(TransformActuator_obj,endColorTransform),HX_CSTRING("endColorTransform")},
	{hx::fsObject /*::flash::media::SoundTransform*/ ,(int)offsetof(TransformActuator_obj,endSoundTransform),HX_CSTRING("endSoundTransform")},
	{hx::fsObject /*::flash::geom::ColorTransform*/ ,(int)offsetof(TransformActuator_obj,tweenColorTransform),HX_CSTRING("tweenColorTransform")},
	{hx::fsObject /*::flash::media::SoundTransform*/ ,(int)offsetof(TransformActuator_obj,tweenSoundTransform),HX_CSTRING("tweenSoundTransform")},
	{ hx::fsUnknown, 0, null()}
};
#endif
