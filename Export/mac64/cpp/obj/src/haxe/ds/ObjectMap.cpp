...
HX_STACK_FRAME("haxe.ds.ObjectMap","new",0x27af5498,"haxe.ds.ObjectMap.new","/usr/lib/haxe/std/cpp/_std/haxe/ds/ObjectMap.hx",29,0x941a7216)
{
	...
	HX_STACK_LINE(31)
	this->__KeyRefs = ::haxe::ds::IntMap_obj::__new();
}
;
	return null();
}
...
Dynamic ObjectMap_obj::get( Dynamic key){
	HX_STACK_FRAME("haxe.ds.ObjectMap","get",0x27aa04ce,"haxe.ds.ObjectMap.get","/usr/lib/haxe/std/cpp/_std/haxe/ds/ObjectMap.hx",41,0x941a7216)
	HX_STACK_THIS(this)
	HX_STACK_ARG(key,"key")
	HX_STACK_LINE(41)
