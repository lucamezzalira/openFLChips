...
{
		HX_STACK_FRAME("flash.display.Stage","dummyTrace",0x475ba937,"flash.display.Stage.dummyTrace","flash/display/Stage.hx",329,0x8d64160c)
		HX_STACK_THIS(this)
		HX_STACK_LINE(329)
		::haxe::Log_obj::trace(HX_CSTRING(""),hx::SourceInfo(HX_CSTRING("Stage.hx"),329,HX_CSTRING("flash.display.Stage"),HX_CSTRING("dummyTrace")));
	}
return null();
}
...
{
		HX_STACK_FRAME("flash.display.Stage","__setActive",0x470cb0ae,"flash.display.Stage.__setActive","flash/display/Stage.hx",1038,0x8d64160c)
		HX_STACK_THIS(this)
		...
		if (((this->active != value))){
			...
			if ((value)){
				...
				if (((  (((focus->__get((int)0).StaticCast< ::flash::display::InteractiveObject >() != null()))) ? bool(focus->__get((int)0).StaticCast< ::flash::display::InteractiveObject >()->get_needsSoftKeyboard()) : bool(false) ))){
					...
					Void run(){
						HX_STACK_FRAME("*","_Function_4_1",0x520333fa,"*._Function_4_1","flash/display/Stage.hx",1064,0x8d64160c)
						{
							HX_STACK_LINE(1064)
