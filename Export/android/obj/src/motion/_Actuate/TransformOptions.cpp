...
{
HX_STACK_FRAME("motion._Actuate.TransformOptions","new",0x91b60fea,"motion._Actuate.TransformOptions.new","motion/Actuate.hx",464,0xcac92ba8)
...
Float strength = __o_strength.Default(1);
	HX_STACK_FRAME("motion._Actuate.TransformOptions","color",0xa875276d,"motion._Actuate.TransformOptions.color","motion/Actuate.hx",480,0xcac92ba8)
	HX_STACK_THIS(this)
	...
	HX_STACK_ARG(alpha,"alpha")
{
		struct _Function_1_1{
			inline static Dynamic Block( Float &value,Float &strength){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","motion/Actuate.hx",482,0xcac92ba8)
				{
...
::motion::actuators::IGenericActuator TransformOptions_obj::sound( Dynamic volume,Dynamic pan){
	HX_STACK_FRAME("motion._Actuate.TransformOptions","sound",0xdee542d9,"motion._Actuate.TransformOptions.sound","motion/Actuate.hx",501,0xcac92ba8)
	HX_STACK_THIS(this)
