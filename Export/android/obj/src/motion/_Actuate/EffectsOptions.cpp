...
{
HX_STACK_FRAME("motion._Actuate.EffectsOptions","new",0xd8cd76d4,"motion._Actuate.EffectsOptions.new","motion/Actuate.hx",429,0xcac92ba8)
...
::motion::actuators::IGenericActuator EffectsOptions_obj::filter( Dynamic reference,Dynamic properties){
	HX_STACK_FRAME("motion._Actuate.EffectsOptions","filter",0x8473f9c4,"motion._Actuate.EffectsOptions.filter","motion/Actuate.hx",444,0xcac92ba8)
	HX_STACK_THIS(this)
...
static hx::StorageInfo sMemberStorageInfo[] = {
	...
	{hx::fsObject /*::flash::display::DisplayObject*/ ,(int)offsetof(EffectsOptions_obj,target),HX_CSTRING("target")},
	{ hx::fsUnknown, 0, null()}
};
#endif
