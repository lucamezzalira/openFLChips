...
Void ApplicationMain_obj::main( ){
{
		...
		HX_STACK_LINE(32)
		::flash::Lib_obj::create( Dynamic(new _Function_1_1()),(int)0,(int)0,(int)30,(int)16777215,(int((int((int((int((int((int((int((int((int((int(::flash::Lib_obj::HARDWARE) | int(_g))) | int(_g1))) | int(_g2))) | int(_g3))) | int(_g4))) | int(_g5))) | int(_g6))) | int(_g7))) | int(_g8))) | int(_g9)),HX_CSTRING("BlackJack"),null(),null());
	}
return null();
}
